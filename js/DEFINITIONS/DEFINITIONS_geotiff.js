...
//----------------------------------------------------------------------------------------------------
//ビューアのタイトル
DEFINITIONS.title = '3D地質図：5万分の1地質図幅 11［京都］-030 御在所山（位置情報付きラスター画像）';
//画面左下コピーライトGSJのリンク先
DEFINITIONS.link = 'https://www.gsj.jp/Map/JP/geology4-11.html#11030';
...
DEFINITIONS.overlay = {
							'type'		: 'geo',
							'options'	: {
											'world'	: 'geo/GSJ_MAP_G050_11030_1989_F1.wld',
											'image'	: 'geo/GSJ_MAP_G050_11030_1989_F1.jpg'
											},
							'click'		: false,
							'layers'	: false
						};
